...
class IntegrationMatchSetsTests(IntegrationTests):
    ...
    # TODO: Delete this after converting to the new way of specifying sets
    def test_match_one_case_pattern(self):
        """'
        Test set matching by matching a single case, specifying sets using
        the 'old' pattern method and a combination
        """
        assets = {
            "index.yaml": """
                host_type_regex: ^normal
